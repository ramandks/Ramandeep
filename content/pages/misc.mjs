...
export const privacy = legal('privacy', 'Privacy Policy',
  'How Orbo Flow collects, uses, stores and protects personal information.', [
    { h: 'Who we are', p: ['Orbo Flow ("we", "us") is headquartered in New Zealand and provides AI agent, automation, data and integration services to business clients worldwide. This policy explains how we handle personal information collected through our website and in the course of delivering services.'] },
    ...
    { h: 'Client data and data residency', p: ['Where we process data on behalf of a client, we act as a processor under that client\'s instructions and under a written data processing agreement. Processing region is selected by the client — options include New Zealand, Australia, Singapore, the European Union and the United States. We disclose every sub-processor involved in writing before processing begins.'] },
    ...
    { h: 'Your rights', p: ['Under the New Zealand Privacy Act 2020 and, where applicable, the GDPR, you may request access to, correction of, or deletion of your personal information, and object to certain processing. Contact our privacy officer to make a request; we respond within 20 working days.'] },
...
export const terms = legal('terms', 'Terms of Service',
  'The terms that apply to use of the Orbo Flow website and services.', [
    ...
    { h: 'Warranties and liability', p: ['The website is provided on an "as is" basis without warranties of any kind to the extent permitted by law. Our liability under any services agreement is limited as set out in that agreement. Nothing in these terms limits liability that cannot lawfully be limited, including under the Consumer Guarantees Act 1993 where it applies.'] },
    { h: 'Governing law', p: ['These terms are governed by the laws of New Zealand, and the courts of New Zealand have non-exclusive jurisdiction over any dispute.'] },
  ]);
